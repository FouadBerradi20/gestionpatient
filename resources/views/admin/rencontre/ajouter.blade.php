    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal" action="{{ route('rencontre.store') }}" method="POST"  >
                        {{ csrf_field() }}
                            <div class="box-body">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-12">
                                <input id="libelle" type="text" class="form-control" name="lieu" placeholder="Name">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-12">
                                <input id="libelle" type="text" class="form-control" name="duree" placeholder="Name">
